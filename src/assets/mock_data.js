const images = import.meta.glob("./Product_imgs/*");
...
const imagePaths = {};
  ...
  for (const path in images) {
    ...
    imagePaths[imageName] = (await images[path]()).default;
  }
...
const product_data = [
  {
    ...
    category: "guitar",
    image: `${imagePaths.p1}`,
    description: "A versatile electric guitar suitable for various music genres.",
    price: 599.99,
  },
  {
    id: 2,
    ...
    category: "guitar",
    image: `${imagePaths.p2}`,
    description: "A classic burst finish Fender Stratocaster with vintage tones.",
    price: 899.99,
  },
  {
    id: 3,
  ...
  },
  {
    ...
    category: "bass",
    image: `${imagePaths.p7}`,
    description: "Perfect for bassists who want extended range and versatility.",
    price: 549.99,
  },
  {
    id: 8,
  ...
  },
  {
    ...
    description: "Designed for modern bassists who need extended low-end range.",
    price: 599.99,
  },
  {
    id: 16,
    ...
    description: "High-fidelity studio monitors for accurate audio playback. 7 inch speakers 4th generation",
    price: 349.99,
  },
  {
    id: 17,
  ...
  },
  {
    ...
    description: "Combines the warmth of an acoustic guitar with the versatility of an electric.",
    price: 699.99,
  },
  {
    id: 19,
    ...
    description: "Perfect for smooth fretless bass playing and expressive slides.",
    price: 799.99,
  },
  {
    id: 20,
    ...
    description: "All-in-one PA system for small gigs, presentations, and outdoor events.",
    price: 349.99,
  },
  {
    id: 21,
  ...
  },
  {
    ...
    description: "A versatile bass with active electronics for tonal flexibility.",
    price: 749.99,
  },
  {
    id: 24,
  ...
  },
  {
    ...
    description: "Crafted with a solid spruce top for clear and resonant acoustic tones.",
    price: 699.99,
  },
  {
    id: 27,
    ...
    description: "Compact bass with a shorter scale length for comfortable playability.",
    price: 399.99,
  },
  {
    id: 28,
    ...
    description: "Take your music poolside or to the beach with this waterproof speaker.",
    price: 89.99,
  },
  {
    id: 29,
  ...
  },
  {
    ...
    description: "High-end bass with versatile electronics and ergonomic design.",
    price: 1299.99,
  },
  {
    id: 32,
    ...
    description: "Compact mixer for combining multiple audio sources in live setups.",
    price: 199.99,
  },
  {
    id: 33,
    ...
    description: "Securely hang your guitar on the wall for display and easy access.",
    price: 19.99,
  },
];
